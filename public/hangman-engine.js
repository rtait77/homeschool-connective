  ...
  function buildDOM() {
    ...
    style.textContent = `
      *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
      ...
      #keyboard{display:flex;flex-direction:column;align-items:center;gap:6px;width:100%;max-width:440px;}
      .key{width:clamp(34px,8.5vw,44px);height:clamp(34px,8.5vw,44px);border-radius:8px;border:none;font-family:inherit;font-size:clamp(0.78rem,2.7vw,0.95rem);font-weight:800;cursor:pointer;transition:all 0.15s;background:#1e3a5f;color:#f1f5f9;}
      ...
      @media (orientation:landscape) and (max-height:600px){
        ...
        #content-cols{flex-direction:row;align-items:center;gap:4px;flex:1;width:100%;}
