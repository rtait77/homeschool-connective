    ...
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="bg-[#f5f1e9] border border-[#ddd8cc] rounded-xl p-5 mb-6">
        ...
        <ol className="text-sm text-[#5c5c5c] space-y-1 list-decimal list-inside">
          <li>Click the <strong>Print</strong> button below (or use Ctrl+P / Cmd+P)</li>
      ...
      {/* PDF preview embed */}
      <div className="w-full rounded-xl overflow-hidden border border-[#ddd8cc]" style={{ height: '80vh' }}>
        <embed
          src={fileUrl}
