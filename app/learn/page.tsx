...
const games = [
  ...
  {
    title: 'Blast the Gas Giants',
    desc: 'Only 4 of the 8 planets are gas giants! Blast Jupiter, Saturn, Uranus, and Neptune as they fly across space — and leave the rocky inner planets alone.',
  ...
  {
    title: 'Blast the Gas Giants – Easy',
    desc: 'The easy version! Slowly floating asteroids, 5 lives, no miss penalty. Blast Jupiter, Saturn, Uranus, and Neptune — the four gas giants!',
    thumb: '/thumb-asteroid-blast-gas-giants.svg',
