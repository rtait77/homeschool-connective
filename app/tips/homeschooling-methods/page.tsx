...
export default function Page() {
  return (
    <div className="max-w-[780px] mx-auto px-6 py-12">
      ...
      <p className="mb-4 leading-relaxed">In the beginning of our homeschooling journey, we tried several methods. After much trial and error, we decided an eclectic method would be the right fit for our family. Having four kids with four different <Link href="/tips/learning-styles" className="text-[#238FA4] font-bold hover:underline">learning styles</Link>, made it difficult to execute other method choices. I enjoy pulling resources together from a variety of curriculum, downloadable resources, unit studies and board games.</p>
