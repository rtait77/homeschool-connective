  ...
  return (
    <div className="max-w-[780px] mx-auto px-6 py-12">
      ...
      <div className="relative w-full h-56 mb-8 rounded-xl overflow-hidden">
        <Image src="/blog-play-girl-puzzle.avif" alt="Child playing" fill className="object-cover" />
      </div>
      ...
      <div className="relative w-full h-56 mb-8 rounded-xl overflow-hidden">
        <Image src="/blog-play-kids-tractor.avif" alt="Children playing outside" fill className="object-cover" />
      </div>
      ...
      <div className="relative w-full h-56 mb-8 rounded-xl overflow-hidden">
        <Image src="/blog-play-kids-climbing.avif" alt="Children playing on climbing equipment" fill className="object-cover" />
      </div>
      ...
      <div className="relative w-full h-56 mb-8 rounded-xl overflow-hidden">
        <Image src="/blog-play-blocks.avif" alt="Child playing with blocks" fill className="object-cover" />
      </div>
      ...
      <div className="relative w-full h-56 mb-8 rounded-xl overflow-hidden">
        <Image src="/blog-play-pattern-blocks.avif" alt="Child playing with pattern blocks" fill className="object-cover" />
      </div>
