      ...
      <section style={{ background: '#f5f1e9', paddingBottom: '0' }}>
        ...
        <div className="hero-wrap">
          ...
          <div className="hero-text">
            ...
            <p style={{ fontSize: '0.75rem', color: '#a09890' }}>No credit card required · Cancel anytime</p>
          </div>
          {/* Video box — right */}
      ...
      <section className="bg-white px-6 py-14 relative overflow-hidden">
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            ...
            {/* Featured — Mars Lesson (2-col span) */}
            <a href="https://view.genially.com/699e69be43a96797318311da"
              ...
              <div className="relative w-full bg-[#0d1b2a]" style={{ height: '200px' }}>
                ...
                <span className="absolute top-3 right-3 bg-[#ed7c5a] text-white text-xs font-extrabold px-3 py-1 rounded-full">Start here</span>
              </div>
              <div className="p-4 flex flex-col flex-1">
                <h3 className="font-extrabold text-base leading-tight mb-1">Mission to Mars</h3>
                <p className="text-sm text-[#5c5c5c] mb-3">A full multi-stop interactive lesson — explore the planet, its moons, and the rovers. Includes a quiz and rover-building puzzle.</p>
