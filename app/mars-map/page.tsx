...
const LESSONS = [
  ...
  { id: 'build-a-rover',  label: 'Build a Rover',  url: '/build-a-rover',                                 unlockAfter: 'mars-rovers',    audio: 'build a rover.mp3',  image: '/build-a-rover-circle.png',quiz: false, pos: { left: '36%',   top: '42%' } },
