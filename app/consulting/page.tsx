  ...
  return (
    <div style={{ borderTop: '1px solid #e2ddd5' }}>
      ...
      >
        ...
        <span style={{ fontSize: '1.2rem', color: '#238FA4', flexShrink: 0, lineHeight: 1 }}>{open ? '−' : '+'}</span>
      </button>
      {open && (
...
export default function ConsultingPage() {
  ...
  return (
    <div style={{ fontFamily: 'Nunito, sans-serif' }}>
      ...
      <div style={{ backgroundColor: '#f5f1e9', padding: '64px 24px 96px', marginTop: -2, position: 'relative', overflow: 'hidden' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginTop: 40 }}>
            <a href="/pricing" style={{ display: 'inline-block', backgroundColor: '#238FA4', color: '#fff', fontWeight: 800, fontSize: '0.95rem', padding: '12px 32px', borderRadius: 10, textDecoration: 'none' }}>
              See Pricing →
            </a>
          </div>
        </div>
      ...
      <div style={{ backgroundColor: '#fff', padding: '64px 24px 96px', marginTop: -2, position: 'relative', overflow: 'hidden' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20 }}>
            {([
              { src: '/learn-anywhere-1.jpg' },
              { src: '/learn-anywhere-2.jpg' },
              { src: '/learn-anywhere-3.jpg' },
              { src: '/learn-anywhere-4.jpg' },
              { src: '/learn-anywhere-5.jpg' },
              { src: '/learn-anywhere-6.jpg' },
            ] as { src: string | null }[]).map((tile, i) => (
      ...
      {/* ── FAQ ── */}
      <div style={{ backgroundColor: '#fff', padding: '64px 24px', marginTop: -2 }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <div style={{ borderBottom: '1px solid #e2ddd5' }}>
            {[
              ...
              { q: 'How long does it take to get my report?', a: 'Mel typically delivers your report within 3–5 business days of receiving your completed intake form.' },
              { q: 'What subjects does this cover?', a: 'All of them. We recommend resources across a wide range of subjects because learners have a wide range of interests. Core subjects like math, reading, writing, and science are covered — but so is anything else your family is exploring.' },
              { q: 'What ages and grades do you work with?', a: 'Pre-K through high school.' },
              { q: 'What if I have more than one child?', a: 'The intake form includes a section for each child, so Mel can tailor recommendations for multiple children at once — all for the same price.' },
              { q: 'Is this for new homeschoolers or experienced ones?', a: 'Both. Whether you\'re just starting out or you\'ve been at it for years and something isn\'t working, Mel can help.' },
              { q: 'Do you recommend secular or religious curriculum?', a: 'Both. The intake form asks about your preference and Mel matches resources accordingly. No assumptions are made.' },
              { q: 'Is this consulting service for secular and Christian families?', a: 'Yes! Although all of our games, lessons, and printables are secular, our matching system is designed for both secular and Christian families. Mel works with families across the full spectrum and matches curriculum and resources based on your specific preferences.' },
              { q: 'How is this different from googling curriculum reviews?', a: 'Reviews tell you what a curriculum is like. Mel tells you whether it\'s right for your child and your family. She looks at how your child learns, how you teach, what you\'ve already tried, what your schedule looks like, and what your goals are — then matches from there. It\'s the difference between reading a menu and having someone who knows you well order for you.' },
              { q: 'What does the 3 months of email support actually look like?', a: 'After your report is delivered, you can email Mel with follow-up questions for 3 months — whether something isn\'t clicking, you want her opinion before buying something, or you just need a second opinion. She responds within 3–5 business days. Your 3-month window starts from the date your report is delivered, not the date of purchase.' },
              { q: 'Do I get access to the games when I sign up for consulting?', a: 'Yes — when you sign up for consulting, you\'ll receive a 7-day free trial of our educational games. After that, you can choose to add a games subscription separately. There is no free trial for the consulting service itself.' },
              { q: 'Can I get a refund if I change my mind?', a: 'Refunds are not available once the intake form has been sent to you. If you have questions before purchasing, reach out at consulting@homeschoolconnective.com.' },
            ].map((item, i) => (
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        @media (max-width: 640px) {
          ...
          .consulting-hero > div:last-child { min-height: 260px !important; }
          .step-connector { display: none !important; }
          .mel-layout { grid-template-columns: 1fr !important; }
        }
